...
const VehiclePanel = ({setVehiclePanel,setConfirmPanelOpen}) => {
  return (
    <div>
      <h5 onClick={() => {
        ...
        }} className=' w-full p-3 flex items-center border-2 active:border-black rounded-xl justify-between'>
          <img className='h-17 w-1/3'
            ...
            alt="" />
          <div className='w-1/2'>
            <h4 className='font-medium text-lg'> UberGo <span><i className="ri-user-3-fill"></i></span> </h4>
            <h5 className='font-medium text-sm'>2 mins away</h5>
            <p className='font-normal text-xs text-gray-600'>Affordable, compact rides</p>
          </div>
          <h2 className='font-semibold text-1xl text-gray-600'>
            $193.20
          </h2>
        </div>
    </div>
